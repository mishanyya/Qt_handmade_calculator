...
//разрешен только ввод чисел в поле ввода lineEdit
   ...
   /*
    ввод целого числа или числа с точкой
-?\\d+(.\\d{0,})?//это почти работает, правда вместо точки можно вставить любую букву или знак, прада только в количестве один знак
-?\\d+([.]\\d{0,})?//это почти работает, правда если точку поместить в квадратные скопки, то все как надо
*/
   }
